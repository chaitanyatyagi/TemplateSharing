      ...
      {preview ? (
        ...
        <div className="flex flex-col lg:flex-row gap-6 mt-6 bg-paper rounded-lg shadow-sm border border-ink p-6">
          ...
          <div className="lg:w-1/3 flex flex-col gap-3">
            ...
            <div
              className="w-full min-h-56 border-2 border-dashed border-ink bg-cream rounded-md flex flex-col items-center justify-center text-faint text-sm text-center px-3 py-6 cursor-pointer hover:bg-creamAlt transition"
